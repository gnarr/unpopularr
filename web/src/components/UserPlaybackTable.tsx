...
// The per-user watch breakdown on detail pages. Hidden until at least one
// stored session carries a user (rows synced before user tracking gain
// attribution on the next playback sync). Plays the backend can't attribute
// to a user are summarized in the footnote.
  ...
  return (
    <section className="rounded-lg border border-slate-800 bg-slate-900/40">
      ...
      <div className="p-4">
        ...
        {unknownPlayCount !== null && unknownPlayCount > 0 && (
